...
public:
    ...
    void setupUi(QWidget *GitGui)
    {
        ...
        loadButton->setGeometry(QRect(10, 330, 151, 25));
        listWidget_3->raise();
        backButton->raise();
        listWidget_2->raise();
        label->raise();
    ...
    void retranslateUi(QWidget *GitGui)
    {
        ...
        loadButton->setText(QCoreApplication::translate("GitGui", "\320\227\320\260\320\263\321\200\321\203\320\267\320\270\321\202\321\214 \321\204\320\260\320\271\320\273", nullptr));
    } // retranslateUi
