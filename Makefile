...
distdir: FORCE
	...
	$(COPY_FILE) --parents js_object.h mainwindow.h $(DISTDIR)/
...
compiler_moc_header_make_all: moc_js_object.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_js_object.cpp moc_mainwindow.cpp
